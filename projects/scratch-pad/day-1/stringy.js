...
//return string forced to lower case
...
function toDashCase(string) {
    // YOUR CODE BELOW HERE //
/*
I: a string with spaces and possibly some upper case characters
O: a new string where dashes replace the spaces and all characters are lowercase
C: NA
E: NA
*/
//split string by spaces and join string with dashes
